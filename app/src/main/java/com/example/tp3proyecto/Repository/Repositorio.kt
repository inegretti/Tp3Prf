    ...
    companion object {
     ...
     init{
        ...
        // lista.add(Usuario(1,"Admin","12345","admin@gmail.com","41444444",0.0,1.8)) admin.esAdmin=true
         ...
         listaC.add(Ejercicio(1,"FLEXIONES DE BRAZOS","5545456456"))
         listaC.add(Ejercicio(2,"SENTADILLAS","5545456456"))
         listaC.add(Ejercicio(3,"PLANCHAS","5545456456"))
         listaC.add(Ejercicio(4,"ZANCADAS","5545456456"))
         listaC.add(Ejercicio(5,"DOMINADAS","5545456456"))
         listaC.add(Ejercicio(6,"BANDERA HUMANA","5545456456"))
         listaA[1].semana[0].rutina.add(listaC[0])
         listaA[1].semana[0].rutina.add(Ejercicio(1,"flexiones de brazos","5545456456"))
        ...
        //-------------------------------------------------------------------------------------------
         ...
         listaE.add(Ejercicio(2,"SENTADILLAS","5545456456"))
         listaE.add(Ejercicio(3,"PLANCHAS","5545456456"))
         listaE.add(Ejercicio(4,"ZANCADAS","5545456456"))
         listaE.add(Ejercicio(5,"DOMINADAS","5545456456"))
         listaE.add(Ejercicio(6,"BANDERA HUMANA","5545456456"))
